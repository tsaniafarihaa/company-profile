...
const SERVICES = [
  {
    ...
    description:
      "Creative and unique design solutions for branding and marketing.",
  },
  {
    id: 2,
    ...
    <main className="overflow-hidden">
      ...
      <section className="flex flex-col lg:flex-row items-center bg-white py-16 lg:px-24 px-6">
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="lg:w-1/2 p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 mb-8 lg:mb-0"
        >
          <h2 className="text-4xl font-bold text-gray-800 mb-6 flex items-center group">
            <BriefcaseIcon className="h-8 w-8 text-[#2FA4F9] mr-2 transition-colors duration-300" />
            About Us
          </h2>
          ...
          <Link
            href="/about"
            className="mt-4 inline-block bg-[#2FA4F9] text-white font-semibold py-2 px-6 rounded-lg
        hover:bg-[#0E80C2] transition-colors duration-300"
          >
            Learn More
          </Link>
        </motion.div>
        ...
        >
          <Image
            ...
            width={500}
            height={500}
            className="object-cover rounded-lg shadow-lg hover:scale-[1.02] transition-transform duration-300"
            loading="lazy"
            quality={75}
          />
        </motion.div>
